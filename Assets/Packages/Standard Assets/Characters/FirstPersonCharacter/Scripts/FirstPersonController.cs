...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float stamina, staminaDecreaseRate, staminaIncreaseRate, maxStamina;
        ...
        [SerializeField] private AudioClip panting;           // the sound played when character runs out of stamina.
        ...
        private void GetInput(out float speed)
        {
            ...
            else
            {
                ...
                {
                    m_AudioSource.PlayOneShot(panting);
                }
