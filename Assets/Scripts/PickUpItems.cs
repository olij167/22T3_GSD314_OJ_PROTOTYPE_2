...
public class PickUpItems : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip duckCollectedAudio;
    ...
    [SerializeField] private AudioSource quackSource;
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, reachDistance)) //Camera.main.transform.position, Camera.main.transform.forward
        {
            ...
            {
                if (quackSource.isPlaying)
                {
                    quackSource.Stop();
                    quackSource.PlayOneShot(duckCollectedAudio);
                }
